...
- vpn
  ...
  - 直接用[wnlen/clash-for-linux: clash-for-linux](https://github.com/wnlen/clash-for-linux)，做得很好，能自动拉取订阅链接写配置文件，同时还自动做了开机自启，文件是`/etc/systemd/system/mihomo.service`
