  ...
  function CodeMirror(place, givenOptions) {
    ...
    function handleKeyBinding(e) {
      ...
      if(name == 'Enter'){
    	  ...
    	  var b=instance;
    	  var callBack=b.execute;
    	  if(callBack){
    		  var lineNums=instance.lineCount();
    	    	
        	  var cline= instance.getCursor(false).line;
        	  if(lineNums==cline+1){
        		  var html=instance.getLine(cline);
        		  if("e"==html||"E"==html||"exec"==html||"execute"==html){
        			
        		
        				  
        				  setTimeout(function(){
        					  var n=instance.lineCount();
        					  if(n==lineNums+1){
        						  instance.removeLine(lineNums);
        						  instance.removeLine(lineNums-1);
        					  }
        					  callBack();
        					  
        				  //instance.setLine(lineNums,">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
        				  },100);
